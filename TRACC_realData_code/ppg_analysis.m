function [locs, pulsesmooth] = ppg_analysis(physio)
...
%%% this function perform two main tasks: 
%%% 1. perform waveform quality check and output a figure and two numbers
%%% 2. robustly calculate peak locations
